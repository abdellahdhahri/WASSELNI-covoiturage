...
<div class="card" v-if="user">
    ...
    <div class="card__subtitle">{{ user.prenom }}</div>
    <div class="card__subtitle">{{ user.phone_number }}</div>
    <div class="card__wrapper">
        <button class="card__btn">Modify</button>
...
<div class="options" style="display: flex;justify-content: center; align-items: center; margin-top: 20px;margin-bottom: 30px; ">
<div class="cards">
    <div class="card red">
        <p class="tip">Modify Profile</p>
        <p class="second-text"></p>
    </div>
    <div class="card blue">
        <p class="tip">My Reservations</p>
        <p class="second-text"></p>
    </div><router-link to="/listeTrajets"><div class="card green">
        <p class="tip" style="text">My Announcements</p>
        <p class="second-text"></p>
    </div></router-link>
</div>
</div>
   ...
   <!-- <div >
    <h3> Dashboard</h3>
    <h1 v-if="user">Profil de {{ user.name }}
    <p>prenom de profil {{ user.prenom }}</p>
    
    </h1>
    
    <p v-else>Données utilisateur non disponibles.</p>
